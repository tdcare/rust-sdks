...
pub mod native {
    ...
    impl NativeVideoSource {
        ...
        pub fn capture_jetson_frame(&self, dma_buf_fd: std::os::fd::RawFd, width: u32, height: u32, timestamp_us: i64) {
            self.handle.capture_jetson_frame(dma_buf_fd, width, height, timestamp_us)
        }
        ...
        pub fn capture_raw_i420(&self, i420_data: &[u8], width: u32, height: u32, timestamp_us: i64) {
            self.handle.capture_raw_i420(i420_data, width, height, timestamp_us)
        }
