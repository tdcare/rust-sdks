...
$output = cargo build -p libwebrtc --target aarch64-unknown-linux-ohos 2>&1
$output | Where-Object { $_ -match 'error\[|E0308|mismatched|expected|rtc_io_driver' } | Select-Object -First 15
